...
class IncomePeriodFilter extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final IncomePeriodCubit incomePeriodCubit;
  const IncomePeriodFilter({
    super.key,
  ...
  @override
  State<IncomePeriodFilter> createState() => _IncomePeriodFilterState();
}

class _IncomePeriodFilterState extends State<IncomePeriodFilter> {
  PeriodItemData? selectedPeriodItemData;

  @override
  void initState() {
    super.initState();
    selectedPeriodItemData = widget.incomePeriodCubit.state.selectedIncomePeriod;
  }
          ...
          children: [
              ...
              child: RawScrollbar(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final item = widget.incomePeriodCubit.state.incomePeriodList?[index];
                  ...
                  itemCount: widget.incomePeriodCubit.state.incomePeriodList?.length ?? 0,
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.incomePeriodCubit.changeSelectedIncomePeriod(selectedPeriod: selectedPeriodItemData);
                  widget.onDone();
                },
              ),
            ),
          ...
          child: StatefulBuilder(
              builder: (context, setState) {
                return ListView.builder(
                  ...
                  itemCount: widget.incomePeriodCubit.state.incomePeriodList?.length ?? 0,
                  itemBuilder: (context, index) {
                    final filterData = widget.incomePeriodCubit.state.incomePeriodList?[index];
                    return Column(
                      children: [
                        GestureDetector(
                          onTap: () {
