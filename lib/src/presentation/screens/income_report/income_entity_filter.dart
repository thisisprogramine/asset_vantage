...
class IncomeEntityFilter extends StatefulWidget {
  ...
  @override
  State<IncomeEntityFilter> createState() => _IncomeEntityFilterState();
}

class _IncomeEntityFilterState extends State<IncomeEntityFilter> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    super.initState();
    selectedItem = widget.entity ?? widget.incomeEntityCubit.state.selectedIncomeEntity;
  ...
  Widget build(BuildContext context) {
            ...
            children: [
                    ...
                    RawScrollbar(
                      ...
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          final item = widget.incomeEntityCubit.state.incomeEntityList?[index];
                        ...
                        itemCount: widget.incomeEntityCubit.state.incomeEntityList?.length ?? 0,
              ...
              Padding(
                ...
                child: ApplyButton(
                  ...
                  onPressed: () {
                    widget.incomeLoadingCubit.startLoading();
                    widget.incomeAccountCubit.loadIncomeAccount(context: context,selectedEntity: selectedItem, asOnDate: widget.asOnDate)
                        .then((onValue) => widget.incomeLoadingCubit.endLoading());
                    widget.incomeEntityCubit.sortSelectedIncomeEntity(selectedEntity: selectedItem);
    ...
    return Column(
      children: [
        ...
        if (widget.incomeEntityCubit.state.incomeEntityList?.any((element) =>
        (element?.name
            ?.toLowerCase()
            .contains(controller.text.toLowerCase()) ??
            true) ||
