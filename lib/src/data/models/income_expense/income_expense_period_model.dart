...
import '../../../domain/entities/income_expense/income_expense_period_entity.dart';

class IncomeExpensePeriodModel extends IncomeExpensePeriodEntity {
  IncomeExpensePeriodModel({
    this.period,
  }) : super(
      periodList: period ?? []
  );
  ...
  factory IncomeExpensePeriodModel.fromJson(Map<dynamic, dynamic> json) {
    return IncomeExpensePeriodModel(
