...
class ExpenseEntityFilter extends StatefulWidget {
  ...
  @override
  State<ExpenseEntityFilter> createState() => _ExpenseEntityFilterState();
}

class _ExpenseEntityFilterState extends State<ExpenseEntityFilter> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    super.initState();
    selectedItem = widget.entity ?? widget.expenseEntityCubit.state.selectedExpenseEntity;
  ...
  Widget build(BuildContext context) {
            ...
            children: [
                    ...
                    RawScrollbar(
                      ...
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          final item = widget.expenseEntityCubit.state.expenseEntityList?[index];
                        ...
                        itemCount: widget.expenseEntityCubit.state.expenseEntityList?.length ?? 0,
              ...
              Padding(
                ...
                child: ApplyButton(
                  ...
                  onPressed: () {
                    widget.expenseLoadingCubit.startLoading();
                    widget.expenseAccountCubit.loadExpenseAccount(context: context, selectedEntity: selectedItem, asOnDate: widget.asOnDate)
                        .then((onValue) => widget.expenseLoadingCubit.endLoading());
                    widget.expenseEntityCubit.sortSelectedExpenseEntity(selectedEntity: selectedItem);
    ...
    return Column(
      children: [
        ...
        if (widget.expenseEntityCubit.state.expenseEntityList?.any((element) =>
        (element?.name
            ?.toLowerCase()
            .contains(controller.text.toLowerCase()) ??
            true) ||
