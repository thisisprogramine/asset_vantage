...
class PerformanceAsOnDateFilter extends StatefulWidget {
  ...
  @override
  State<PerformanceAsOnDateFilter> createState() => _PerformanceAsOnDateFilterState();
}

class _PerformanceAsOnDateFilterState extends State<PerformanceAsOnDateFilter> {
  String? selectedDate;
        ...
        children: [
          ...
          Expanded(
              child: CalendarDatePicker(
                initialDate: DateTime.tryParse(widget.performanceAsOnDateCubit.state.asOnDate ?? DateTime.now().subtract(const Duration(days: 1)).toString()) ?? DateTime.now().subtract(const Duration(days: 1)),
          ...
          Padding(
            ...
            child: ApplyButton(
              ...
              onPressed: () {
                widget.performanceAsOnDateCubit.changeAsOnDate(asOnDate: selectedDate);
                widget.onDone();
              },
            ),
          ),
