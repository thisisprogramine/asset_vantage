...
class IncomeExpenseNumberOfPeriodModel extends IncomeExpenseNumberOfPeriodEntity {
  IncomeExpenseNumberOfPeriodModel({
  ...
  factory IncomeExpenseNumberOfPeriodModel.fromJson(Map<dynamic, dynamic> json) {
    return IncomeExpenseNumberOfPeriodModel(
