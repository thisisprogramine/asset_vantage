...
class IncomeNumberOfPeriodFilter extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final IncomeNumberOfPeriodCubit incomeNumberOfPeriodCubit;
  const IncomeNumberOfPeriodFilter({
    super.key,
  ...
  @override
  State<IncomeNumberOfPeriodFilter> createState() => _IncomeNumberOfPeriodFilterState();
}

class _IncomeNumberOfPeriodFilterState extends State<IncomeNumberOfPeriodFilter> {
  NumberOfPeriodItemData? selectedNumberOfPeriodItemData;

  @override
  void initState() {
    super.initState();
    selectedNumberOfPeriodItemData = widget.incomeNumberOfPeriodCubit.state.selectedIncomeNumberOfPeriod;
  }
          ...
          children: [
              ...
              child: RawScrollbar(
                ...
                child: StatefulBuilder(builder: (context, setState) {
                  return ListView.builder(
                      ...
                      itemCount: widget.incomeNumberOfPeriodCubit.state.incomeNumberOfPeriodList?.length ?? 0,
                      itemBuilder: (context, index) {
                        final filterData = widget.incomeNumberOfPeriodCubit.state.incomeNumberOfPeriodList?[index];
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.incomeNumberOfPeriodCubit.changeSelectedIncomeNumberOfPeriod(selectedNumberOfPeriod: selectedNumberOfPeriodItemData);
                  widget.onDone();
                },
              ),
            ),
