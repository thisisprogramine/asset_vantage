...
class IncomeAsOnDateFilter extends StatefulWidget {
  ...
  @override
  State<IncomeAsOnDateFilter> createState() => _IncomeAsOnDateFilterState();
}

class _IncomeAsOnDateFilterState extends State<IncomeAsOnDateFilter> {
  String? selectedDate;
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Expanded(
              child: CalendarDatePicker(
                initialDate: DateTime.tryParse(widget.incomeAsOnDateCubit.state.asOnDate ?? DateTime.now().subtract(const Duration(days: 1)).toString()) ?? DateTime.now().subtract(const Duration(days: 1)),
          ...
          Padding(
            ...
            child: ApplyButton(
              ...
              onPressed: () {
                widget.incomeAsOnDateCubit.changeAsOnDate(asOnDate: selectedDate);
                widget.onDone();
              },
            ),
          ),
    ...
    return Column(
      children: [
        ...
        CalendarDatePicker(
          initialDate: DateTime.tryParse(widget.incomeAsOnDateCubit.state.asOnDate ?? DateTime.now().subtract(const Duration(days: 1)).toString()) ?? DateTime.now().subtract(Duration(days: 1)),
          firstDate: DateTime(1980),
