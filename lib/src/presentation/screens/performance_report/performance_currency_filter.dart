...
class PerformanceCurrencyFilter extends StatefulWidget {
  ...
  const PerformanceCurrencyFilter({
    super.key,
  ...
  @override
  State<PerformanceCurrencyFilter> createState() => _PerformanceCurrencyFilterState();
}

class _PerformanceCurrencyFilterState extends State<PerformanceCurrencyFilter> {
  ...
  void initState() {
    super.initState();
    selectedCurrency = widget.performanceCurrencyCubit.state.selectedPerformanceCurrency;
  }
          ...
          children: [
            ...
            Expanded(
              child: RawScrollbar(
                ...
                child: ListView.builder(
                  ...
                  itemCount: widget.performanceCurrencyCubit.state.performanceCurrencyList?.length ?? 0,
                  itemBuilder: (context, index) {
                    final filterData = widget.performanceCurrencyCubit.state.performanceCurrencyList?[index];
                    if((filterData?.code
                        ?.toLowerCase()
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.performanceCurrencyCubit.changeSelectedPerformanceCurrency(selectedCurrency: selectedCurrency, performanceDenominationCubit: widget.performanceDenominationCubit);
                  widget.onDone();
                },
              ),
            ),
              ...
              builder: (context, setState) {
                return Column(
                  children: [
                    ...
                    if((widget.performanceCurrencyCubit.state.performanceCurrencyList?.any((element) =>
                    (element?.code
                        ?.toLowerCase()
                        .contains(controller.text.toLowerCase()) ??
                    true) ||
