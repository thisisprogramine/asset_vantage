...
class NetWorthReturnPercentFilterList extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final NetWorthReturnPercentCubit netWorthReturnPercentCubit;

  const NetWorthReturnPercentFilterList({
    Key? key,
  ...
  @override
  State<NetWorthReturnPercentFilterList> createState() =>
      _NetWorthReturnPercentFilterListState();
}

class _NetWorthReturnPercentFilterListState extends State<NetWorthReturnPercentFilterList> {
  ReturnPercentItemData? selectedReturnPercentItemData;

  @override
  void initState() {
    super.initState();
    selectedReturnPercentItemData = widget.netWorthReturnPercentCubit.state.selectedNetWorthReturnPercent;
  }
          ...
          children: [
              ...
              child: RawScrollbar(
                ...
                child: StatefulBuilder(builder: (context, setState) {
                  return ListView.builder(
                      ...
                      itemCount: widget.netWorthReturnPercentCubit.state.netWorthReturnPercentList?.length ?? 0,
                      itemBuilder: (context, index) {
                        final filterData = widget.netWorthReturnPercentCubit.state.netWorthReturnPercentList?[index];
                        return GestureDetector(
                          onTap: () {
                            if(filterData != null) {
                              setState((){
                                selectedReturnPercentItemData = filterData;
                              });
                            }
                          },
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (selectedReturnPercentItemData?.id == filterData?.id)
                                  Padding(
                                    padding: EdgeInsets.symmetric(
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.netWorthReturnPercentCubit.changeSelectedNetWorthReturnPercent(selectedReturnPercent: selectedReturnPercentItemData);
                  widget.onDone();
                },
              ),
            ),
