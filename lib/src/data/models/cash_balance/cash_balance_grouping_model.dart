...
class CashBalanceGroupingModel extends CashBalanceGroupingEntity{
  CashBalanceGroupingModel({
  ...
  factory CashBalanceGroupingModel.fromJson(Map<dynamic, dynamic> json) {
    ...
    return CashBalanceGroupingModel(
