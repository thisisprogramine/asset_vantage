...
class GetSelectedDashboardEntity extends UseCase<EntityData?, NoParams> {
  final AVRepository _avRepository;

  GetSelectedDashboardEntity(this._avRepository);

  @override
  Future<Either<AppError, EntityData?>> call(NoParams params) async =>
      _avRepository.getSelectedDashboardEntity();
}
