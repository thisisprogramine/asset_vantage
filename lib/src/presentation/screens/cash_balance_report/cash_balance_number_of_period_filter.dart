...
class CashBalanceNumberOfPeriodFilter extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final CashBalanceNumberOfPeriodCubit cashBalanceNumberOfPeriodCubit;
  const CashBalanceNumberOfPeriodFilter({
    super.key,
  ...
  @override
  State<CashBalanceNumberOfPeriodFilter> createState() => _CashBalanceNumberOfPeriodFilterState();
}

class _CashBalanceNumberOfPeriodFilterState extends State<CashBalanceNumberOfPeriodFilter> {
  NumberOfPeriodItemData? selectedNumberOfPeriodItemData;

  @override
  void initState() {
    super.initState();
    selectedNumberOfPeriodItemData = widget.cashBalanceNumberOfPeriodCubit.state.selectedCashBalanceNumberOfPeriod;
  }
          ...
          children: [
              ...
              child: RawScrollbar(
                ...
                child: StatefulBuilder(builder: (context, setState) {
                  return ListView.builder(
                      ...
                      itemCount: widget.cashBalanceNumberOfPeriodCubit.state.cashBalanceNumberOfPeriodList?.length ?? 0,
                      itemBuilder: (context, index) {
                        final filterData = widget.cashBalanceNumberOfPeriodCubit.state.cashBalanceNumberOfPeriodList?[index];
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.cashBalanceNumberOfPeriodCubit.changeSelectedCashBalanceNumberOfPeriod(selectedNumberOfPeriod: selectedNumberOfPeriodItemData);
                  widget.onDone();
                },
              ),
            ),
