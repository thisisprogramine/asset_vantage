...
class ExpenseDenominationFilter extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final ExpenseDenominationCubit expenseDenominationCubit;
  const ExpenseDenominationFilter({
    super.key,
  ...
  @override
  State<ExpenseDenominationFilter> createState() => _ExpenseDenominationFilterState();
}

class _ExpenseDenominationFilterState extends State<ExpenseDenominationFilter> {
  DenominationData? selectedDenominationData;

  @override
  void initState() {
    super.initState();
    selectedDenominationData = widget.expenseDenominationCubit.state.selectedExpenseDenomination;
  }
          ...
          children: [
            ...
            Expanded(
              child: RawScrollbar(
                ...
                child: ListView.builder(
                    ...
                    itemCount: widget.expenseDenominationCubit.state.expenseDenominationList?.length ?? 0,
                    itemBuilder: (context, index) {
                      final filterData = widget.expenseDenominationCubit.state.expenseDenominationList?[index];
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.expenseDenominationCubit.changeSelectedExpenseDenomination(selectedDenomination: selectedDenominationData);
                  widget.onDone();
                },
              ),
            ),
