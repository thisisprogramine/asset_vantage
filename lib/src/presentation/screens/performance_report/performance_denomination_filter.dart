...
class PerformanceDenominationFilter extends StatefulWidget {
  final void Function() onDone;
  final ScrollController scrollController;
  final PerformanceDenominationCubit performanceDenominationCubit;
  const PerformanceDenominationFilter({
    super.key,
  ...
  @override
  State<PerformanceDenominationFilter> createState() => _PerformanceDenominationFilterState();
}

class _PerformanceDenominationFilterState extends State<PerformanceDenominationFilter> {
  DenominationData? selectedDenominationData;

  @override
  void initState() {
    super.initState();
    selectedDenominationData = widget.performanceDenominationCubit.state.selectedPerformanceDenomination;
  }
          ...
          children: [
            ...
            Expanded(
              child: RawScrollbar(
                ...
                child: ListView.builder(
                    ...
                    itemCount: widget.performanceDenominationCubit.state.performanceDenominationList?.length ?? 0,
                    itemBuilder: (context, index) {
                      final filterData = widget.performanceDenominationCubit.state.performanceDenominationList?[index];
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.performanceDenominationCubit.changeSelectedPerformanceDenomination(selectedDenomination: selectedDenominationData);
                  widget.onDone();
                },
              ),
            ),
