...
class ExpenseCurrencyFilter extends StatefulWidget {
  ...
  @override
  State<ExpenseCurrencyFilter> createState() => _ExpenseCurrencyFilterState();
}

class _ExpenseCurrencyFilterState extends State<ExpenseCurrencyFilter> {
  ...
  void initState() {
    super.initState();
    selectedCurrency = widget.expenseCurrencyCubit.state.selectedExpenseCurrency;
  }
          ...
          children: [
            ...
            Expanded(
              child: RawScrollbar(
                ...
                child: ListView.builder(
                  ...
                  itemCount: widget.expenseCurrencyCubit.state.expenseCurrencyList?.length ?? 0,
                  itemBuilder: (context, index) {
                    final filterData = widget.expenseCurrencyCubit.state.expenseCurrencyList?[index];
                    if((filterData?.code
                        ?.toLowerCase()
            ...
            Padding(
              ...
              child: ApplyButton(
                ...
                onPressed: () {
                  widget.expenseCurrencyCubit.changeSelectedExpenseCurrency(selectedCurrency: selectedCurrency, expenseDenominationCubit: widget.expenseDenominationCubit);
                  widget.onDone();
                },
              ),
            ),
              ...
              builder: (context, setState) {
                return Column(
                  children: [
                    ...
                    if((widget.expenseCurrencyCubit.state.expenseCurrencyList?.any((element) =>
                    (element?.code
                        ?.toLowerCase()
                        .contains(controller.text.toLowerCase()) ??
                    true) ||
